...
public class IngredientController {
	...
	@PostMapping("/new")
	public String createIngredient(@RequestParam Long uomId,@RequestParam Long recipeId,@ModelAttribute Ingredient ingredient) {
		Ingredient createdIngredient = ingredientService.createIngredient(ingredient, recipeId, uomId);
		System.out.println("### ingredient with id"+createdIngredient.getId()+" is created ###");
